...
class lib_verifycode
{
   ...
   // public $lib_memcache;
	...
	{
	    $code_key = isset($params['code_key']) ? $params['code_key'] : '';
        $width= isset($params['width']) ? $params['width'] : 100;
        $height = isset($params['height']) ? $params['height'] : 25;
        $code_num = isset($params['code_num']) ? $params['code_num'] : 4;
	    if(empty($code_key))
	    {
	        $code_key = $this->get_cur_user_key();
	    }
	    $this->_code_key = 'xcxleju_' . $code_key;
	...
	public function get_math_code()
	{
    	...
    	$code_res = $this->CI->lib_redis->set($this->_code_key, $code_result);
    ...
    {        
	    ...
	    $code_res = $this->CI->lib_redis->set($this->_code_key, $code);
